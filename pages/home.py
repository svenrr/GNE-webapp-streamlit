...
def write():
    ...
    st.markdown(!["Good News Everyone"](data/Good news everyone (1).png))
    ...
    st.write('On this WebApp you will find an analyser page, on which you can try out our sentiment analysis, categorization and the extractive summary. Furthermore we included a preview of what a live newsfeed could look like in later stages of develpoment.')

    st.write('Thank you for being interested in our project and now enjoy some good news (hopefully)')
